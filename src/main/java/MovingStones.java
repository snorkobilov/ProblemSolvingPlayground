...
public class MovingStones {
     ...
     * to an
     * unoccupied position between those endpoints.  Formally, let's say the stones are currently at positions x, y,
     * z with
     * x < y < z.  You pick up the stone at either position x or position z, and move that stone to an integer
     * position k,
     * with x < k < z and k != y.
     * <p>
